...
const ProjectSectionNav: React.FC<ProjectSectionNavProps> = ({ sections }) => {
  ...
  return (
    <nav
      className={`relative md:sticky md:top-[65px] z-40 bg-white/80 dark:bg-[#2a2a2a]/80 backdrop-blur-xl border-b border-gray-200 dark:border-gray-700 transition-all duration-300 ${
        isSticky ? 'shadow-lg' : ''
      }`}
    >
